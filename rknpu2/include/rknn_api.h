...
#ifndef RKNN_JAVA_RKNPU2_INCLUDE_RKNN_API_H_
#define RKNN_JAVA_RKNPU2_INCLUDE_RKNN_API_H_
...
typedef enum _rknn_mem_sync_mode {
  ...
  RKNN_MEMORY_SYNC_BIDIRECTIONAL =
      ...
      RKNN_MEMORY_SYNC_FROM_DEVICE, /* the mode used for consistency of data
                                       access between device and CPU in both
                                       directions. */
} rknn_mem_sync_mode;
...
#endif // RKNN_JAVA_RKNPU2_INCLUDE_RKNN_API_H_
